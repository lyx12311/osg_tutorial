...
<details>
  ...
  <ol>
    ...
    <li><a href="#Prepare to submit jobs</a></li>
...
## To start
Here's why:
* Create a folder with all the following files (assuming you are running python): [fib.sub](https://github.com/lyx12311/osg_tutorial/blob/main/fib.sub), [wrapper.sh](https://github.com/lyx12311/osg_tutorial/blob/main/wrapper.sh), and [python_build.tgz](https://zenodo.org/record/7324844/files/python_build.tgz?download=1).
 
* wrapper.sh is the shell scrip to run your code, which typically contains the following:
...
* fib.sub is the submission file, the main things to change are: 
